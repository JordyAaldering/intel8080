...
impl std::fmt::Debug for Opcode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Opcode::POP_B => f.write_str("POP B"),
            ...
            Opcode::PUSH_B => f.write_str("PUSH B"),
            ...
            Opcode::POP_D => f.write_str("POP D"),
            ...
            Opcode::PUSH_D => f.write_str("PUSH D"),
            ...
            Opcode::POP_H => f.write_str("POP H"),
            ...
            Opcode::PUSH_H => f.write_str("PUSH H"),
